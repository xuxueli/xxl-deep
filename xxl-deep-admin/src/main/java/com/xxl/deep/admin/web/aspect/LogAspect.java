package com.xxl.deep.admin.web.aspect;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.xxl.deep.admin.annotation.Log)")
     ...
     * @throws Throwable
     */
    //@Around("@annotation(com.xxl.deep.admin.annotation.Log)")
    @Around("logPointcut()")
    ...
    private void log(Log log, HttpServletRequest request, ProceedingJoinPoint joinPoint, Object result, long startTime, long endTime) {
        ...
        // generate
        XxlDeepLog xxlDeepLog = new XxlDeepLog();
        xxlDeepLog.setType(log.type().getCode());
        xxlDeepLog.setModule(log.module().name());
        xxlDeepLog.setTitle(log.title());
        xxlDeepLog.setContent(content);
        xxlDeepLog.setOperator(operator);
        xxlDeepLog.setIp(ip);

        logService.insert(xxlDeepLog);
    }
